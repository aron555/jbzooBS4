...
$output = '<input type="text" name="q" id="mo" class=" col-lg-10 col-sm-9 col-xs-6 tm-search-input" size="' . $params->get('field_size', 20) . '" value="' . htmlspecialchars(JFactory::getApplication()->input->get('q', '', 'string')) . '" />';
...
{
	$button = '<button class="col-lg-2 col-sm-3 col-xs-6 tm-search-button hasTooltip ' . $suffix . ' " type="submit" title="' . JText::_('MOD_FINDER_SEARCH_BUTTON') . '">ИСКАТЬ</button>';
