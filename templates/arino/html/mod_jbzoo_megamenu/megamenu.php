    ...
    <div class="navbar navbar-hover p-0 shadow-none">
        ...
        <div class="dropdown dropdown-convey-width" data-animation="fadeIn">
            ...
            <a
                ...
                <span class="megamenu-title megamenu-title-small d-inline-block d-md-none">Межкомнатные</span>
                <span class="megamenu-title d-none d-md-inline-block" onclick="location.href='<?= $url ?>'">Межкомнатные двери</span>
            </a>
