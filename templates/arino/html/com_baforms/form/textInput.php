...
<?php
		...
		<input type="text" data-type="<?php echo $options[4]; ?>"  placeholder='<?php echo htmlspecialchars($options[2], ENT_QUOTES); ?>'
	    	name="<?php echo $element->id; ?>" <?php echo $attr; ?> class="form-control tm-form-<?php echo $element->id; ?>" >
<?php
if (isset($options[5]) && strpos($options[5], 'zmdi') !== false) { ?>
