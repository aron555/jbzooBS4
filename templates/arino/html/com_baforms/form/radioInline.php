...
for ($i = 0; $i < count($option); $i++) {
    ...
    ?>
    <div class="<?php echo $class; ?> form-check form-check-inline">
        <input id="tm-form-check-<?php echo $element->id.$i; ?>" class="form-check-input" type='radio' name="<?php echo $element->id; ?>" value='<?php echo $value; ?>'
            <?php echo $attr; ?>/>
        <label class="form-check-label" for="tm-form-check-<?php echo $element->id.$i; ?>"> <?php echo $text; ?></label>
    </div>
<?php
}
