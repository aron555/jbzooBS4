    ...
    public static function drawHTMLPage($id)
    {
        ...
        if ($popup['display_popup'] == 1) {
            if ($popup['button_type'] != 'link') {
                ...
                $html .= "<button type='button' data-popup='popup-form-".$id."' class='popup-btn btn btn-primary'>";
                $html .= htmlspecialchars($popup['button_lable'], ENT_QUOTES);
                $html .= '</span>';
                $html .= '</div>';
            } else {
        ...
        $html .= '<form novalidate class="baform-'.$id.'" action="' . $url. '"';
