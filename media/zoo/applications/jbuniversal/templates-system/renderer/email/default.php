                                                ...
                                                <table style="width: 100%; float: left">
                                                    ...
                                                    <tr>
                                                        <td class="esd-block-text" style="padding: 0 10px;">
                                                            <h1 style="margin: 0">
                                                                <a style="color: #ffffff; font-size: 14px; text-decoration: none;" href="<?= $url ?>">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table style="width: 100%; float: right; text-align: right;">
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <a style="color: #ffffff; font-size: 14px;" href="<?= $url ?>/contacts">Контакты</a>
                                                                    </td>
                                                                </tr>
                                                                </tbody>
                                                            </table>
