                ...
                if ($this->params->get('config.items_show', 1) && count($this->items)) {
                    ...
                    if ($this->category->hasChildren()) {
                        foreach ($this->category->getChildren() as $child) {
                            ...
                            // get items
                            $childitems = $this->app->table->item->getByCategory($child->getApplication()->id, $child->id, true, null, $item_order, 0, $maxItems, false);
                            // render items
                            if (count($childitems) > 0) {
                                ...
                                <div class="my-5">
                                    ...
                                    <div class="row <?php echo (count($childitems) > 3) ? 'slick' : ''; ?>">
                                        <?php
