...
<div class="card tizer hoverable">
    <div class="row pt-3">
    ...
    <div class="card-body d-flex align-items-end flex-column">
        ...
        <?php if ($this->checkPosition('text')) : ?>
            <div class="item-text row mr-auto">
        ...
        <?php if ($this->checkPosition('properties')) : ?>
            <div class="item-properties mr-auto">
        ...
        <div class="row mb-0 align-items-center align-items-end mt-auto mr-auto w-100">
            ...
            <?php if ($this->checkPosition('buttons')) : ?>
                <div class="col-3 item-buttons text-right ml-auto pr-0">
