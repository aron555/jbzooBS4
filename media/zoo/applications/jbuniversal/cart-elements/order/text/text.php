...
class JBCartElementOrderText extends JBCartElementOrder
{
    ...
    public function renderSubmission($params = array())
    {
        ...
        return $this->app->html->_(
            ...
            'size="50" maxlength="255" class="form-control '.$params->get('class').'" '.$params->get('required').' pattern="'.$params->get('pattern').'" placeholder="'.$params->get('placeholder').'" id="' . $this->htmlId() . '"'
        );
    }
