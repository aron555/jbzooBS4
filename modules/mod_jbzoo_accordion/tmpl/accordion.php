...
echo $zoo->categorymodule->render($category, $params, $flat = "accordion", $level = 1, 'id="zoo-list-'.$category->alias.'" class="list-group zoo-list zoo-list-accordion '.$class.'"', true);