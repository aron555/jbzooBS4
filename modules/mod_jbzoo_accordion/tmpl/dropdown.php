...
echo $zoo->categorymodule->render($category, $params, $flat = "dropdown", $level = 1, 'id="zoo-list-'.$category->alias.'" class="zoo-list zoo-list-dropdown dropdown-menu white z-depth-1 dropright"', true);